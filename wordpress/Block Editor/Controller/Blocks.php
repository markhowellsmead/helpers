...
class Block
{
	...
	/**
	 * Plugin equivalent of get_template_part() to manually render
     * a block through PHP.
	 *
	 * Usage: 
	 	$block_controller->renderBlock(name: 'BannerView', args: $args);
	 *
	 * @param string $name
	 * @param array $args
	 * @return void
	...
	{
		$plugin_instance = shp_get_instance();
		$dir = $plugin_instance->dir;
